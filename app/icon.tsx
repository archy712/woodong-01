...
// satori(next/og)는 <text>를 제외한 SVG 요소를 그대로 렌더링하므로 원시 SVG로 작성 가능.
const CORAL = "#EF6339";
    ...
    >
      ...
      >
        ...
        <ellipse
          ...
          opacity={0.5}
        />
        <circle cx={14} cy={27} r={2.6} fill={AMBER} />
        <circle cx={24} cy={30} r={2.6} fill={AMBER} />
        <circle cx={34} cy={27} r={2.6} fill={AMBER} />
      </svg>
    </div>,
    { ...size },
  );
