...
2. mcp__context7__query-docs로 최신 문서 조회
   query 파라미터에 단일 개념으로 범위를 좁힌 질문 전달
   예: query="responsive design breakpoints", query="form input patterns"
```
...
mcp__context7__query-docs({
  ...
  query: "responsive design breakpoints"
})
```
