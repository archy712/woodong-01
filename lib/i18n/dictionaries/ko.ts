...
export const ko: Dictionary = {
  ...
  // TODO(i18n): Task 035 신규 키 — en/ja/zh는 한국어 그대로다. 실제 번역은 Task 040.
  expenses: {
    sectionTitle: "지출 내역",
    addButton: "지출 등록",
  ...
  exports: {
    menuLabel: "데이터 내보내기",
    menuDescription:
      "회비·지출·정산 기록을 CSV로 받습니다. 총무가 바뀔 때 인수인계용으로 쓰세요.",
    datasetLabel: {
      dues: "회비 청구 현황",
      payments: "납부 이력",
      expenses: "지출 내역",
    ...
    settlementCsvButton: "CSV로 받기",
    itemTypeIncome: "수입",
    itemTypeExpense: "지출",
    formerMemberLabel: "탈퇴한 멤버",
    columns: {
      dues: {
        cycleTitle: "회비 항목",
        period: "기간",
