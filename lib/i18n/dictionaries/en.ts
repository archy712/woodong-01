...
export const en: Dictionary = {
  ...
  groups: {
    ...
    announcements: {
      ...
      notifiedCountSuffix: " members were notified.",
  ...
  settlements: {
    ...
    publish: {
      ...
      notifiedToastSuffix: " members were notified.",
  ...
  votes: {
    ...
    closeNotifiedCountSuffix: " members were notified of the results.",
  ...
  notifications: {
    ...
    unreadCountSuffix: " new notifications",
    allReadMessage: "You're all caught up.",
    markAllReadSuccessSuffix: " notifications marked as read.",
    markReadErrorToast:
